...
from odoo.addons.workflow_studio.wizard.studio_export_wizard import FIELDS_TO_EXPORT
...
class StudioExportModel(models.Model):
    _name = 'workflow.studio.export.model'
    # _table = "studio_export_model"
    ...
    excluded_fields = fields.Many2many(
        "ir.model.fields",
        relation="ir_model_fields_studio_export_model_rel",
        column1="studio_export_model_id",
        column2="ir_model_fields_id",
