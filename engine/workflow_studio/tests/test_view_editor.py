...
class TestEditView(TestStudioController):
    ...
    def test_edit_view_binary_and_attribute(self):
        ...
        add_binary_op = {
            ...
            'node': {'tag': 'field',
                     ...
                     'field_description': {'type': 'binary',
                                           ...
                                           'name': 'x_workflow_studio_binary_field_WocAO',
        ...
        self.assertViewArchEqual(
            ...
            """
              <form>
                <field name="display_name"/>
                <field filename="x_workflow_studio_binary_field_WocAO_filename" name="x_workflow_studio_binary_field_WocAO"/>
                <field invisible="True" name="x_workflow_studio_binary_field_WocAO_filename"/>
              </form>
            """
        )
        ...
        add_widget_op = {
            'type': 'attributes',
            'target': {'tag': 'field',
                       'attrs': {'name': 'x_workflow_studio_binary_field_WocAO'},
                       'xpath_info': [{'tag': 'form', 'indice': 1},
                                      {'tag': 'field', 'indice': 2}]},
            'position': 'attributes',
            'node': {'tag': 'field',
                     'attrs': {'filename': 'x_workflow_studio_binary_field_WocAO_filename',
                               'name': 'x_workflow_studio_binary_field_WocAO',
                               'id': 'x_workflow_studio_binary_field_WocAO'},
                     'children': [],
                     'has_label': True},
        ...
        self.assertViewArchEqual(
            ...
            """
              <form>
                <field name="display_name"/>
                <field filename="x_workflow_studio_binary_field_WocAO_filename" name="x_workflow_studio_binary_field_WocAO" widget="pdf_viewer"/>
                <field invisible="True" name="x_workflow_studio_binary_field_WocAO_filename"/>
              </form>
            """
        )
    ...
    def test_edit_view_create_attribute_attribute(self):
        ...
        with self.assertRaisesRegex(UserError, "Only the Form view can be edited in Workflow Studio."):
            self.edit_view(base_view, operations=[op], model='res.users')
        ...
        operation = {
            ...
            'node': {
                ...
                'field_description': {
                    'type': 'binary',
                    'field_description': 'New File',
                    'name': 'x_workflow_studio_field_fDthx',
                    'model_name': 'res.partner'
                }
            ...
            <sheet>
                <notebook>
                    <page>
                        <group>
                            <group name="group_left">
                                <field filename="x_workflow_studio_field_fDthx_filename" name="x_workflow_studio_field_fDthx"/>
                                <field invisible="True" name="x_workflow_studio_field_fDthx_filename"/>
                            </group>
                            <group name="group_right"/>
                        </group>
                    </page>
    ...
    def test_edit_attribute_studio_groups(self):
        ...
        with self.debug_mode():
            arch = self.env['ir.actions.server'].with_context(workflow_studio=True).get_view(view.id)['arch']
    ...
    def test_edit_attribute_studio_groups_tree_column_invisible(self):
        ...
        for view_type, arch, expected_modifiers in [
            ...
            arch = self.env['res.partner'].with_context(workflow_studio=True).get_view(view.id)['arch']
            tree = etree.fromstring(arch)
    ...
    def test_open_users_form_with_studio(self):
        ...
        """
        arch = self.env['res.users'].with_context(workflow_studio=True).get_view(self.env.ref('base.view_users_form').id)['arch']
    ...
    def test_add_many2one_with_custom_rec_name(self):
        ...
        add_many2one_field_op = {
            ...
            "node": {
                ...
                "field_description": {
                    ...
                    "special": False,
                    "name": "x_workflow_studio_many2one_field_sNT7g",
                    "model_name": "res.partner",
        ...
        self.assertViewArchEqual(
            ...
            """
              <form>
                <field name="display_name" />
                <field name="x_workflow_studio_many2one_field_sNT7g" options="{&quot;create_name_field&quot;:&quot;acc_number&quot;}"/>
              </form>
            """
        )
