...
class TestViewNormalization(TransactionCase):
    ...
    def setUp(self):
        ...
        self._request_pushed = False
        self.base_view = self.env.ref('base.view_partner_form')
        view_types = {
            view_type for view_type, _label in self.env['ir.ui.view'].fields_get(['type'])['type']['selection']
        }
        self.gantt_supported = 'gantt' in view_types
        self.gantt_view = self.env['ir.ui.view']
        if self.gantt_supported:
        ...
        self._request_pushed = True

    def _test_view_normalization(self, original, expected, view='form'):
        if view == 'gantt':
            if not self.gantt_supported:
                self.skipTest("gantt view type is not available in this Odoo build")
        ...
        self.env[self.view.model].with_context(workflow_studio=True, load_all_views=True).get_view(view.id, view.type)
    ...
    def test_view_normalization_22(self):
        ...
        """, """
            <data>
              ...
              <xpath expr="/form/sheet/notebook/page/field[@name='child_ids']/kanban//field[@name='name']" position="after">
                <div class="o_dropdown_kanban dropdown" name="workflow_studio_div_302a40">
                  <a role="button" class="dropdown-toggle o-no-caret btn" data-bs-toggle="dropdown" href="#">
                    <span class="fa fa-bars fa-lg" title="menu"/>
                  </a>
                  <div class="dropdown-menu" role="menu" name="workflow_studio_div_4e2ccd">
        ...
        """, """
            <data>
              <xpath expr="/form/sheet/notebook" position="after">
                <group name="workflow_studio_group_a9eb51">
                  <p>hello world!</p>
                </group>
                <group name="workflow_studio_group_70d54a">
                  <p>foo bar baz</p>
                </group>
                <group name="workflow_studio_group_71063a">
                  <p>spam eggs bacon</p>
                </group>
              </xpath>
            </data>
    ...
    def test_view_normalization_25(self):
        ...
        """, """
            <data>
              <xpath expr="/form/sheet/notebook/page" position="after">
                <page name="workflow_studio_page_302a40">
                  <p>hello world!</p>
                </page>
                <page name="workflow_studio_page_4e2ccd">
                  <p>foo bar baz</p>
                </page>
                <page name="workflow_studio_page_ff8328">
                  <p>spam eggs bacon</p>
                </page>
              </xpath>
            </data>
    ...
    def test_view_normalization_27(self):
        ...
        """, """
            <data>
              <xpath expr="/form//field[@name='website']" position="after">
                <div name="workflow_studio_div_302a40">
                  <field name="create_uid"/>
                </div>
                <div name="workflow_studio_div_4e2ccd">
                  <field name="write_uid"/>
                </div>
              </xpath>
            </data>
