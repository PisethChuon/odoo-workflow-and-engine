...
class TestStudioApproval(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.rule = cls.env['workflow.studio.approval.rule'].create({
            'active': False,
        ...
        cls.rule_with_domain = cls.env['workflow.studio.approval.rule'].create({
            'active': False,
            'model_id': partner_model.id,
            'method': cls.METHOD,
            'message': "You didn't say the magic word!",
        ...
        cls.rule_exclusive = cls.env['workflow.studio.approval.rule'].create({
            'active': False,
            'model_id': partner_model.id,
            'method': cls.METHOD,
            'message': "You didn't say the magic word!",
        ...
        cls.rule_exclusive_with_domain = cls.env['workflow.studio.approval.rule'].create({
            'active': False,
            'model_id': partner_model.id,
            'method': cls.METHOD,
            'message': "You didn't say the magic word!",
    ...
    def setUp(self):
        ...
        self.addCleanup(self.env['workflow.studio.approval.rule']._unregister_hook)
        ...
        with mute_logger('odoo.sql_db'):
            with self.assertRaises(IntegrityError, msg="Shouldn't have 2 entries for the same rule+record"):
                with self.cr.savepoint():
                    self.env['workflow.studio.approval.entry'].with_user(self.manager).create({
    ...
    def test_01_single_rule(self):
        ...
        approval_result = self.env['workflow.studio.approval.rule'].with_user(self.user).check_approval(
            model=self.MODEL,
            res_id=self.record.id,
            method=self.METHOD,
            action_id=False)
    ...
    def test_04_rule_rejection(self):
        ...
        approval_result = self.env['workflow.studio.approval.rule'].with_user(self.manager).check_approval(
            model=self.MODEL,
            res_id=self.record.id,
            method=self.METHOD,
            action_id=False)
    ...
    def test_05_different_users(self):
        ...
        approval_info = dict(self.env['workflow.studio.approval.rule'].with_user(self.manager).get_approval_spec(
            [{
                'model': self.MODEL,
                'res_id': self.record.id,
                'method': self.METHOD,
    ...
    def test_07_forbidden_record(self):
        ...
        self.env['workflow.studio.approval.rule'].with_user(self.manager).get_approval_spec([{
            'model': MODEL,
    ...
    def test_08_archive(self):
        ...
        approval_result = self.env['workflow.studio.approval.rule'].with_context(active_test=False).with_user(self.manager).check_approval(
            model=self.MODEL,
            res_id=self.record.id,
            method=self.METHOD,
            action_id=False)
    ...
    def test_10_exclusive_collision(self):
        ...
        self.env['workflow.studio.approval.rule'].create({
            'active': True,
    ...
    def test_11_approval_activity(self):
        ...
        self.env['workflow.studio.approval.rule'].with_user(self.user).check_approval(
            model=self.MODEL,
            res_id=self.record.id,
            method=self.METHOD,
            action_id=False)
        approval_request = self.env['workflow.studio.approval.request'].search(
    ...
    def test_15_approval_notification_order(self):
        ...
        lower_level_rule = self.env['workflow.studio.approval.rule'].create({
            'active': True,
    ...
    def test_16_batched_approval_spec(self):
        ...
        all_approvals = self.env['workflow.studio.approval.rule'].with_user(self.user).get_approval_spec(
            [{
                'model': self.MODEL,
                'res_id': self.record.id,
                'method': self.METHOD,
...
class TestStudioApprovalPost(TransactionCase):
    ...
    def test_approval_method_patch(self):
        ...
        rule = self.env['workflow.studio.approval.rule'].create({
            'active': True,
