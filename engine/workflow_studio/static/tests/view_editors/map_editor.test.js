...
class Task extends models.Model {
    ...
    _views = {
        "map,1": `
            <map res_partner='partner_id' routing='true' hide_name='true' hide_address='true' workflow_studio_map_field_ids="[1,2]">
...
test("marker popup fields in editor sidebar", async () => {
    ...
    onRpc("/workflow_studio/edit_view", async (request) => {
        ...
        const arch = `
            <map res_partner='partner_id' routing='true' hide_name='true' hide_address='true' workflow_studio_map_field_ids="[2]">
                <field name='description' string='Description'/>
            </map>`;
