...
import { assertEqual, stepNotInStudio, nextTick } from "@workflow_studio/../tests/tours/tour_helpers";
...
function patchReportEditorModelForSilentSave() {
    ...
    const { ReportEditorModel } = odoo.loader.modules.get(
        "@workflow_studio/client_action/report_editor/report_editor_model"
    );
...
let silentPatch;
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition_xml", {
    steps: () => [
        {
        ...
        {
            trigger:
                ".o_web_studio_xml_resource_selector .o_web_studio_xml_resource_select_menu input:value('workflow_studio.test_report_document (workflow_studio.test_report_document)')",
        },
        {
        ...
        {
            trigger:
                ".o-dropdown--menu .o_select_menu_item:contains('workflow_studio.test_report (workflow_studio.studio_test_report_view)')",
            run: "click",
        },
        {
            trigger: ".o_web_studio_code_editor.ace_editor",
...
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition_discard", {
    steps: () => [
        {
            trigger: ".o_web_studio_sidebar input[id='name']",
            run: "edit modified in test && click body",
...
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition_cancel_discard", {
    steps: () => [
        {
            trigger: ".o_web_studio_sidebar input[id='name']",
            run: "edit modified in test && click body",
...
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition_xml_discard", {
    steps: () => [
        {
            trigger: ".o_web_studio_sidebar button[name='report_edit_sources']",
            run: "click",
...
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition_error", {
    steps: () => [
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .odoo-editor-editable p:eq(0)",
            run: "editor edited with odoo editor",
...
registry.category("web_tour.tours").add("workflow_studio.test_basic_report_edition_xml_error", {
    steps: () => [
        {
            trigger: ".o_web_studio_sidebar button[name='report_edit_sources']",
            run: "click",
...
registry.category("web_tour.tours").add("workflow_studio.test_report_reset_archs", {
    steps: () => [
        {
...
let downloadProm;
const steps = [];
registry.category("web_tour.tours").add("workflow_studio.test_print_preview", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_table_rendering", {
    steps: () => [
        {
            trigger:
...
registry.category("web_tour.tours").add("workflow_studio.test_field_placeholder", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_add_field_blank_report", {
    steps: () => [
        {
            // edit reports
...
registry.category("web_tour.tours").add("workflow_studio.test_toolbar_appearance", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_edition_without_lang", {
    steps: () => [
        {
            trigger:
...
registry.category("web_tour.tours").add("workflow_studio.test_report_xml_other_record", {
    steps: () => [
        {
            trigger: ".o_web_studio_sidebar button[name='report_edit_sources']",
            run: "click",
...
registry.category("web_tour.tours").add("workflow_studio.test_partial_eval", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_render_multicompany", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_add_non_searchable_field", {
    steps: () => [
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .odoo-editor-editable p:eq(2)",
            async run(helpers) {
...
registry.category("web_tour.tours").add("workflow_studio.test_report_edition_binary_field", {
    steps: () => [
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .odoo-editor-editable p:eq(2)",
            async run(helpers) {
...
registry.category("web_tour.tours").add("workflow_studio.test_report_edition_dynamic_table", {
    steps: () => [
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .odoo-editor-editable p:eq(2)",
            async run(helpers) {
...
registry.category("web_tour.tours").add("workflow_studio.test_saving_xml_editor_reload", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_error_at_loading", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_error_at_loading_debug", {
    steps: () => [
        {
            trigger: "body:not(:has(.o_error_dialog)) .o-web-studio-report-editor",
            run: "click",
...
registry.category("web_tour.tours").add("workflow_studio.test_xml_and_form_diff", {
    steps: () => [
        {
            trigger: ".o-web-studio-report-editor-wysiwyg :iframe .odoo-editor-editable p:eq(2)",
            run() {
        ...
        },
        {
            ...
            run() {
                ...
                assertEqual(
                    currentViewKey,
                    "workflow_studio.report_editor_customization_diff.view._web_studio.test_report_document"
                );
            },
        },
        {
        ...
        {
            trigger:
                ".o-dropdown--menu .o_select_menu_item:contains(workflow_studio.test_report_document)",
            run: "click",
        },
        {
        ...
        {
            trigger:
                ".o_form_view .o_field_widget[name='view_name']:contains(workflow_studio.test_report_document)",
        },
        {
            trigger:
...
registry.category("web_tour.tours").add("workflow_studio.test_remove_branding_on_copy", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_different_view_document_name", {
    steps: () => [
        {
            trigger: ".o_web_studio_sidebar button[name='report_edit_sources']",
            run: "click",
        ...
        {
            trigger:
                ".o-dropdown--menu .o_select_menu_item:contains('workflow_studio.test_report_document (workflow_studio.test_report_document_1)')",
        },
    ],
});

registry.category("web_tour.tours").add("workflow_studio.test_edit_main_arch", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_edit_in_t_call", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_edit_main_and_in_t_call", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_image_crop", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_translations_are_copied", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_reports_view_concurrence", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_dont_translate_on_save", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_do_not_delete_unspecial_spans", {
    steps: () => [
        {
            trigger: "body :iframe .odoo-editor-editable#wrapwrap span",
            run() {
...
registry.category("web_tour.tours").add("workflow_studio.test_edit_header_only_company", {
    steps: () => [
        {
...
registry.category("web_tour.tours").add("workflow_studio.test_report_without_view", {
    steps: () => [
        {
            trigger: ".o_menu_sections button:contains('Reports')",
            run: "click",
