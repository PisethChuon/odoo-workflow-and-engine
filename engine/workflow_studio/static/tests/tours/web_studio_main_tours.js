...
import { randomString } from "@workflow_studio/utils";
import { assertEqual, stepNotInStudio } from "@workflow_studio/../tests/tours/tour_helpers";

const localStorage = browser.localStorage;
let createdAppString = null;
let createdMenuString = null;

function openHomeMenuFromNavbar() {
    const menuToggle =
        document.querySelector("nav.o_main_navbar > a.o_menu_toggle:not(.d-none)") ||
        document.querySelector(".o_navbar_apps_menu .dropdown-toggle:not(.d-none)");
    menuToggle?.click();
}

registry.category("web_tour.tours").add("web_studio_main_and_rename_smoke", {
    url: "/odoo?debug=1",
    steps: () => [
        {
        ...
        {
            trigger: ".o_web_client:not(.o_in_workflow_studio)",
        },
        {
            trigger: "body",
            run: () => {
                if (!document.body.classList.contains("o_home_menu_background")) {
                    openHomeMenuFromNavbar();
                }
            },
        },
        {
...
registry.category("web_tour.tours").add("web_studio_main_and_rename", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o_web_studio_form_view_editor, .o_menu_toggle, .o_navbar_apps_menu .dropdown-toggle",
        },
        {
        ...
        {
            trigger: `.o_web_client:not(.o_in_workflow_studio)` /* wait to be out of studio */,
        },
        {
            trigger: "body",
            timeout: 60000 /* previous step reloads registry, etc. - could take a long time */,
        ...
        {
            trigger: `.o_web_client:not(.o_in_workflow_studio) .o_menu_brand:visible:contains(${createdAppString}), .o_home_menu .o_app:contains(${createdAppString})`,
        },
        {
        ...
        {
            // edit an app
            trigger: `.o_app[data-menu-xmlid*="workflow_studio"]:contains(${createdAppString})`,
            run: function () {
        ...
        },
        {
            ...
            // the rename operation (/workflow_studio/rename_field + /workflow_studio/edit_view)
        ...
        },
        {
            // switch in list view
            trigger:
                '.o_web_studio_views_icons a[title="List"], .o_web_studio_menu .o_web_studio_views_icons a[title="List"]',
            run: "click",
        },
        {
        ...
        {
            // click on the created app
            trigger: '.o_app[data-menu-xmlid*="workflow_studio"]:last',
            run: "click",
        },
        {
            // switch to form view
...
registry.category("web_tour.tours").add("web_studio_new_submenu_tour", {
    ...
    steps: () => [
        ...
        {
            // click on the created app
            trigger: '.o_app[data-menu-xmlid*="workflow_studio"]:first',
            run: "click",
        },
        {
            // create a new menu
...
registry.category("web_tour.tours").add("web_studio_custom_field_tour", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o_web_client.o_in_workflow_studio",
        },
        {
            // go to home menu
...
registry.category("web_tour.tours").add("web_studio_custom_background_tour", {
    ...
    steps: () => [
        {
            content: "open the home menu first when the session starts in an action",
            trigger: "body",
            run: () => {
                if (!document.body.classList.contains("o_home_menu_background")) {
                    document.querySelector(".o_menu_toggle:not(.o_menu_toggle_back)")?.click();
                }
            },
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_home_menu_background_custom.o_home_menu_background:not(.o_in_workflow_studio)",
            run: () => null,
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_home_menu_background_custom.o_home_menu_background.o_in_workflow_studio",
            run: () => null,
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_home_menu_background.o_in_workflow_studio:not(.o_home_menu_background_custom)",
            run: () => null,
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_home_menu_background:not(.o_in_workflow_studio.o_home_menu_background_custom)",
            run: () => null,
        },
    ],
});
...
registry.category("web_tour.tours").add("web_studio_create_app_with_pipeline_and_user_assignment", {
    steps: () => [
        ...
        },
        {
            trigger: "body",
            run: () => {
                const viewsButton = [...document.querySelectorAll(".o_web_studio_editor .o_menu_sections button")]
                    .find((button) => button.textContent.trim() === "Views");
                viewsButton?.click();
            },
        },
        {
            trigger:
                ".o_web_studio_thumbnail_item.o_web_studio_thumbnail_kanban, .o_web_studio_views_icons > a[title='Kanban']",
            timeout: 60000,
            run: "click",
        },
        {
...
registry.category("web_tour.tours").add("web_studio_add_button_type_object", {
    steps: () => [
        {
            trigger: "a[data-menu-xmlid='workflow_studio.studio_test_partner_menu']",
            run: "click",
        },
        {
...
registry.category("web_tour.tours").add("web_studio_monetary_create", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o_app[data-menu-xmlid='workflow_studio.studio_app_menu']",
            run: "click",
        },
        ...
        },
        {
            ...
            run() {
                assertEqual(this.anchor.value, "Currency (x_workflow_studio_currency_id)");
            },
        },
        {
            // currency field is in the view
            trigger: ".o_web_studio_view_renderer div[data-field-name='x_workflow_studio_currency_id']",
            run: "click",
        },
        {
...
registry.category("web_tour.tours").add("web_studio_monetary_change_currency_name", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger: ".o_web_studio_view_renderer [data-field-name='x_workflow_studio_currency_test']",
            run: "click",
        },
        {
        ...
        {
            // click on monetary
            trigger: "div[data-field-name^='x_workflow_studio_monetary_test']",
            run: "click",
        },
        {
            ...
            trigger: ".o_web_studio_sidebar .o_web_studio_property_currency_field input",
            run() {
                assertEqual(this.anchor.value, "NewCurrency (x_workflow_studio_currency_test)");
            },
        },
    ],
});
...
registry.category("web_tour.tours").add("web_studio_related_monetary_creation", {
    ...
    steps: () => [
        ...
        },
        {
            run: "click",
            trigger:
                ".o_model_field_selector_popover_item[data-name='x_workflow_studio_monetary_test'] button",
        },
        {
        ...
        },
        {
            ...
            trigger: ".o_web_studio_view_renderer [data-field-name='x_workflow_studio_currency_id']",
        },
    ],
});
...
registry.category("web_tour.tours").add("web_studio_monetary_change_currency_field", {
    ...
    steps: () => [
        // Change currency and verify that the view take the changes into account (the dollar appears)
        {
            ...
            trigger: "a[data-menu-xmlid='workflow_studio.studio_app_menu']",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger: "div [name='x_workflow_studio_currency_test2'] input",
            run: "edit USD",
        },
        {
        ...
        },
        {
            ...
            trigger: "div[name='x_workflow_studio_monetary_test'] span",
            run() {
        ...
        },
        {
            ...
            trigger: ".o-dropdown--menu .o_select_menu_item:contains('Test2')",
            run: "click",
        },
        {
            // wait until the currency has been set (also test the reactivity)
            trigger:
                ".o_web_studio_sidebar .o_web_studio_property_currency_field input:value('X Workflow Studio Currency Test2')",
        },
        {
            // by changing the currency, we should have a $ symbol in the renderer
            trigger: "div[name^='x_workflow_studio_monetary'] span",
            run() {
                assertEqual(this.anchor.textContent, "$ 0.00");
            },
        },
...
registry.category("web_tour.tours").add("web_studio_monetary_change_currency_not_in_view", {
    ...
    steps: () => [
        ...
        {
            // currency field is in the view and click on it
            trigger: ".o_web_studio_view_renderer div[data-field-name='x_workflow_studio_currency_test2']",
            run: "click",
        },
        {
            trigger: ".o_web_studio_properties.active",
...
registry.category("web_tour.tours").add("web_studio_monetary_add_existing_monetary", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            trigger: ".o_web_studio_sidebar .o_web_studio_property_currency_field input",
            run() {
                assertEqual(this.anchor.value, "X Studio Currency Test (x_workflow_studio_currency_test)");
            },
        },
        {
            // currency field is in the view
            trigger: "div[data-field-name='x_workflow_studio_currency_test']",
        },
    ],
});
    ...
    .add("web_studio_monetary_create_monetary_with_existing_currency", {
        ...
        steps: () => [
            ...
            },
            {
                ...
                trigger: ".o_form_renderer div[data-field-name^='x_workflow_studio_monetary']",
                run() {
