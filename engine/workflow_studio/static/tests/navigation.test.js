...
import { StudioClientAction } from "@workflow_studio/client_action/studio_client_action";
import { FormEditorCompiler } from "@workflow_studio/client_action/view_editor/editors/form/form_editor_compiler";
import { FormEditorRenderer } from "@workflow_studio/client_action/view_editor/editors/form/form_editor_renderer/form_editor_renderer";
import { ListEditorRenderer } from "@workflow_studio/client_action/view_editor/editors/list/list_editor_renderer";
import { ViewEditor } from "@workflow_studio/client_action/view_editor/view_editor";
...
test("reload the studio view", async () => {
    ...
    await getService("workflow_studio").reload();
    await animationFrame();
...
test("user context is not polluted when getting views", async () => {
    ...
    onRpc("/workflow_studio/get_studio_action", async () => {
...
test("new app shortcut is unavailable in workflow mode", async () => {
    await mountWithCleanup(WebClientEnterprise);
    await animationFrame();
