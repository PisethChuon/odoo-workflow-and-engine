...
function getModelOptions(isMultiCompany) {
    const modelOptions = {
        ...
        has_approval: {
            label: _t("Has Approval"),
            help: _t("Enable workflow approval engine defaults for this model"),
            value: true,
        },
        is_transient: {
            label: _t("Transient (Wizard)"),
            help: _t("Create a transient model suited for wizard dialogs"),
            value: false,
        },
    };
    if (!isMultiCompany) {
...
export class ModelConfigurator extends Component {
    static template = "workflow_studio.ModelConfigurator";
    static components = {};
    static props = {
...
export class ModelConfiguratorDialog extends Component {
    ...
    static template = "workflow_studio.ModelConfiguratorDialog";
