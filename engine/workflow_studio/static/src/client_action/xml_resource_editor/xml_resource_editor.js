...
class ViewSelector extends SelectMenu {
    static template = "workflow_studio.ViewSelector";
    static choiceItemTemplate = "workflow_studio.ViewSelector.ChoiceItemRecursive";
    static props = {
        ...SelectMenu.props,
        choices: {
            optional: true,
...
export class XmlResourceEditor extends Component {
    static template = "workflow_studio.XmlResourceEditor";
    ...
    async loadResources(resourceId) {
        const resources = await rpc("/workflow_studio/get_xml_editor_resources", {
            key: resourceId,
        });
