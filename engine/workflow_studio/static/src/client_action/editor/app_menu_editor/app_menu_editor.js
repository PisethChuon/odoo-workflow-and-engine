...
import { MenuCreatorDialog } from "@workflow_studio/client_action/menu_creator/menu_creator";
import { useDialogConfirmation, useSubEnvAndServices } from "@workflow_studio/client_action/utils";
...
class EditMenuDialog extends Component {
    ...
    static template = "workflow_studio.AppMenuEditor.EditMenuDialog";
    ...
    onNewMenu() {
        this.addDialog(MenuCreatorDialog, {
            confirm: async (data) => {
                await rpc("/workflow_studio/create_new_menu", {
...
export class AppMenuEditor extends Component {
    ...
    static template = "workflow_studio.AppMenuEditor";
