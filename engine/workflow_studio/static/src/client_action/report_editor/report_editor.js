...
import { useReportEditorModel } from "@workflow_studio/client_action/report_editor/report_editor_model";
import { ReportEditorWysiwyg } from "@workflow_studio/client_action/report_editor/report_editor_wysiwyg/report_editor_wysiwyg";
import { ReportEditorXml } from "@workflow_studio/client_action/report_editor/report_editor_xml/report_editor_xml";
...
class ReportEditor extends Component {
    static template = "workflow_studio.ReportEditor";
...
registry.category("actions").add("workflow_studio.report_editor", ReportEditor);

class ReportsTab extends Component {
    static template = "workflow_studio.ReportEditor.ReportsTab";
    static props = {
        tab: Object,
        editedAction: Object,
        openTab: Function,
...
registry
    .category("workflow_studio.editor_tabs")
