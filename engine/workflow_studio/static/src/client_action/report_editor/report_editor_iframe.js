...
import { getCssFromPaperFormat } from "@workflow_studio/client_action/report_editor/utils";
import { useThrottleForAnimation } from "@web/core/utils/timing";
import { ErrorDisplay } from "@workflow_studio/client_action/report_editor/error_display";

export class ReportEditorIframe extends Component {
    static components = { ErrorDisplay };
    static template = "workflow_studio.ReportEditor.Iframe";
    static props = {
        iframeKey: String,
        iframeSource: String,
