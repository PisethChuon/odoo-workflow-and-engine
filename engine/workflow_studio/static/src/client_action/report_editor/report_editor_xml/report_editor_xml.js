...
import { XmlResourceEditor } from "@workflow_studio/client_action/xml_resource_editor/xml_resource_editor";
import { useEditorMenuItem } from "@workflow_studio/client_action/editor/edition_flow";
import { ReportEditorSnackbar } from "@workflow_studio/client_action/report_editor/report_editor_snackbar";
...
export class ReportEditorXml extends Component {
    ...
    static template = "workflow_studio.ReportEditorXml";
    static props = {
    ...
    getDefaultResource(resourcesOptions, mainKey) {
        ...
        if (mainResource) {
            const studioExtension = resourcesOptions.find((opt) => {
                ...
                return (
                    key.includes("workflow_studio.report_editor_customization") &&
    ...
    get diffProps() {
        return {
            ...
            context: {
                workflow_studio: false,
                workflow_studio_report_diff: true,
