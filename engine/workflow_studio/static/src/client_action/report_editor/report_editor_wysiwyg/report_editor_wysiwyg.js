...
import { memoizeOnce } from "@workflow_studio/client_action/utils";
...
class UndoRedo extends Component {
    static template = "workflow_studio.ReportEditorWysiwyg.UndoRedo";
    static props = {
        state: Object,
...
class ResetConfirmationPopup extends ConfirmationDialog {
    static template = "workflow_studio.ReportEditorWysiwyg.ResetConfirmationPopup";
    static props = {
...
export class ReportEditorWysiwyg extends Component {
    ...
    static template = "workflow_studio.ReportEditorWysiwyg";
