...
import { randomName } from "@workflow_studio/client_action/view_editor/editors/utils";
...
class SearchEditorController extends Component {
    ...
    static template = "workflow_studio.SearchEditorController";
...
class SearchComponents extends Component {
    ...
    static props = {};
    static template = "workflow_studio.SearchEditor.Sidebar.Components";
...
class SimpleElementEditor extends Component {
    ...
    static template = "workflow_studio.SearchEditor.SimpleElementEditor";
...
class SearchEditorSidebar extends Component {
    static template = "workflow_studio.ViewEditor.SearchEditorSidebar";
    static props = {
