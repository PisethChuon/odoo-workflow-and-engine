...
import * as formEditorRendererComponents from "@workflow_studio/client_action/view_editor/editors/form/form_editor_renderer/form_editor_renderer_components";
...
import { AddButtonAction } from "@workflow_studio/client_action/view_editor/interactive_editor/action_button/action_button";
    ...
    setup() {
        ...
        useEffect(
            (rootEl) => {
                ...
                const styleOptionalColumnsAndCleanupChatter = () => {
                    ...
                    const liveChatters = Array.from(
                        rootEl.querySelectorAll(".o-mail-Form-chatter, .o-mail-Chatter")
                    ).filter((el) => !el.closest(".o_web_studio_add_chatter"));
                    if (liveChatters.length) {
                        rootEl
                            .querySelectorAll(".o_web_studio_add_chatter")
                            .forEach((el) => el.remove());
                    }
                };
                styleOptionalColumnsAndCleanupChatter();
