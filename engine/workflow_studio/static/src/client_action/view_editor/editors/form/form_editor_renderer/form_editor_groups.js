...
import { studioIsVisible } from "@workflow_studio/client_action/view_editor/editors/utils";
...
function extendGroup(GroupClass) {
    class Group extends GroupClass {
        // FormCompiler may pass runtime visibility flags on group slots (e.g. isVisible).
        // Allow it explicitly so Studio group wrappers don't crash on strict props checks.
        static props = [...GroupClass.props, "studioXpath?", "studioIsVisible?", "isVisible?"];
...
class InnerGroupItemComponent extends Component {
    static template = "workflow_studio.Form.InnerGroup.ItemComponent";
    static props = {
        cell: { type: Object },
        slots: { type: Object },
    };
...
export class InnerGroup extends _InnerGroup {
    static template = "workflow_studio.Form.InnerGroup";
    getRows() {
...
OuterGroup.template = "workflow_studio.Form.OuterGroup";
