...
import { NewButtonBoxDialog } from "@workflow_studio/client_action/view_editor/interactive_editor/properties/button_properties/new_button_box_dialog";
import { FieldSelectorDialog } from "@workflow_studio/client_action/view_editor/editors/components/field_selector_dialog";
import { SelectionContentDialog } from "@workflow_studio/client_action/view_editor/interactive_editor/field_configuration/selection_content_dialog";
import {
    randomName,
    studioIsVisible,
    useStudioRef,
...
export class FormLabel extends components.FormLabel {
    static template = "workflow_studio.FormLabel";
    static props = {
...
export class Notebook extends components.Notebook {
    static template = "workflow_studio.Notebook.Hook";
...
export class StatusBarButtons extends components.StatusBarButtons {
    static template = `workflow_studio.FormViewAddButtonAction`;
    static components = {
...
export class StatusBarFieldHook extends Component {
    static template = "workflow_studio.AddElementHook";
    static props = {
                ...
                viewEditorModel.doOperation({
                    ...
                    node: {
                        ...
                        field_description: {
                            ...
                            name: randomName(`x_workflow_studio_selection_field`),
...
export class ButtonBox extends components.ButtonBox {
    static template = "workflow_studio.ButtonBox";
    static components = {};
    static props = {
