...
import {
    ExistingFields,
    NewFields,
} from "@workflow_studio/client_action/view_editor/editors/components/view_fields";
import { ViewStructures } from "@workflow_studio/client_action/view_editor/editors/components/view_structures";
import { Property } from "@workflow_studio/client_action/view_editor/property/property";
import { Properties } from "@workflow_studio/client_action/view_editor/interactive_editor/properties/properties";
import { ButtonProperties } from "@workflow_studio/client_action/view_editor/interactive_editor/properties/button_properties/button_properties";
import { FieldProperties } from "@workflow_studio/client_action/view_editor/interactive_editor/properties/field_properties/field_properties";
import { GroupProperties } from "@workflow_studio/client_action/view_editor/editors/form/form_editor_sidebar/properties/group_properties/group_properties";
import { LabelProperties } from "@workflow_studio/client_action/view_editor/editors/form/form_editor_sidebar/properties/label_properties/label_properties";
import { PageProperties } from "@workflow_studio/client_action/view_editor/editors/form/form_editor_sidebar/properties/page_properties/page_properties";
...
import { WidgetProperties } from "@workflow_studio/client_action/view_editor/interactive_editor/properties/widget_properties/widget_properties";
...
export class FormEditorSidebar extends Component {
    static template = "workflow_studio.ViewEditor.FormEditorSidebar";
    static props = {
