...
import { StudioView } from "@workflow_studio/client_action/view_editor/studio_view";
...
export class ViewEditor extends Component {
    ...
    static template = "workflow_studio.ViewEditor";
...
registry.category("actions").add("workflow_studio.view_editor", ViewEditor);
