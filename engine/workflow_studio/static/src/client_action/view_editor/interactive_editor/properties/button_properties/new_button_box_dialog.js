...
import { FontAwesomeIconSelector } from "@workflow_studio/client_action/components/font_awesome_icon_selector/font_awesome_icon_selector";

export class NewButtonBoxDialog extends Component {
    static template = "workflow_studio.NewButtonBoxDialog";
    static components = {
        Dialog,
