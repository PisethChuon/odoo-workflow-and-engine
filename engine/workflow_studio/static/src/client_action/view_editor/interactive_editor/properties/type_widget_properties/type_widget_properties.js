...
} from "@workflow_studio/client_action/view_editor/interactive_editor/properties/type_widget_properties/type_specific_and_computed_properties";

export class TypeWidgetProperties extends Component {
    static template =
        "workflow_studio.ViewEditor.InteractiveEditorProperties.Field.TypeWidgetProperties";
    ...
    async onChangeCurrency(value) {
        ...
        if (this.props.node.field.manual) {
            proms.push(
                rpc("/workflow_studio/set_currency", {
