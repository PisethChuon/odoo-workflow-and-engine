...
import { useDialogConfirmation } from "@workflow_studio/client_action/utils";
...
export class SelectionValuesEditor extends Component {
    ...
    static template = "workflow_studio.SelectionValuesEditor";
...
export class RelationalFieldConfigurator extends Component {
    static template = "workflow_studio.RelationalFieldConfigurator";
...
export class FieldConfigurationDialog extends Component {
    ...
    static template = "workflow_studio.FieldConfigurationDialog";
...
export class FilterConfiguration extends Component {
    ...
    static template = "workflow_studio.FilterConfiguration";
    static props = {
        resModel: { type: String },
        configurationModel: { type: Object },
    };
