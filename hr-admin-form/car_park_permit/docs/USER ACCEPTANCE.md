...
This UAT verifies that the Car Park Permit process works as expected for business users and is ready for production use.

## 3. Test Scope

- Create a new car park permit request
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UAT-01 | Request submission | Create and submit a new car park permit request | Employee | User can access Workflow and Car Park Permit | 1. Open Workflow.<br>2. Go to Car Park Permit.<br>3. Click New Request.<br>4. Enter the required information.<br>5. Submit the request. | The request is created successfully and moves to Waiting Approval. The approver receives a notification. |  |  |
...
### 5.4 Issuance and Tracking

| Scenario ID | Business Flow | Test Scenario | Role | Preconditions | Steps | Expected Result | Actual Result | Status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UAT-07 | Request issuance | Issue an approved request | Admin | The request has already been approved | 1. Open My Requests.<br>2. Open My Request List.<br>3. Open the approved request.<br>4. Complete the task.<br>5. Click Issue. | The request status changes to Issued and the record is ready for business use. |  |  |
