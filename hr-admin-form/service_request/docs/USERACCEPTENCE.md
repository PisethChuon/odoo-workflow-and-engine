...
This UAT verifies that the Service Request process works as expected for business users and is ready for production use.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UAT-01 | Request submission | Create and submit a new service request | Employee | User can access Workflow and Service Request | 1. Open Workflow.<br>2. Go to Service Request.<br>3. Click New Request.<br>4. Enter the required information.<br>5. Submit the request. | The request is created successfully and moves to Waiting Approval. The approver receives a notification. |  |  |
