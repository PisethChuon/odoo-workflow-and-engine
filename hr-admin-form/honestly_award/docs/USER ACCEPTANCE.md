...
This UAT verifies that the Honestly Award process works as expected for business users and is ready for production use.

## 3. Test Scope

- Create a new Honestly Award request
- Review, approve, reject, or rework a request
- Resubmit a request after rework
- Complete post-approval actions when required
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UAT-01 | Request submission | Create and submit a new Honestly Award request | Employee | User can access Workflow and Honestly Award | 1. Open Workflow.<br>2. Go to Honestly Award.<br>3. Click New Request.<br>4. Enter the required information.<br>5. Submit the request. | The request is created successfully and moves to Waiting Approval. The approver receives a notification. |  |  |
...
### 5.4 Post-Approval and Tracking

| Scenario ID | Business Flow | Test Scenario | Role | Preconditions | Steps | Expected Result | Actual Result | Status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UAT-07 | Post-approval action | Complete post-approval processing when required | Admin | The request has already been approved and requires Admin processing | 1. Open My Requests.<br>2. Open My Request List.<br>3. Open the approved request.<br>4. Complete the required processing step.<br>5. Save or confirm completion. | The request is processed successfully according to the configured workflow and remains traceable in the system. |  |  |
